        ...
        <div class="main-content">
            ...
            <div class="main-content-inner padding-page-content">
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <form class="form-horizontal" role="form" id="form" action="${ctx }/tagcount/errorvaluelist.vm" method="post">
								<!-- MIS系统面包屑 -->
	                                    ...
	                                    <thead>
	                                        <tr>
	                                            ...
	                                            <th class="align-center"><i class="ace-icon fa fa-tag"></i>
	                                             ...
	                                             <th class="align-center" style="width:200px" data-sort-col="DATA_COUNT"><i class="ace-icon fa fa-bar-chart "></i>
	                                                	标签值域不符企业数
	                                            </th>
	                                     ...
	                                     <tbody>
											...
											<c:forEach items="${pageInfo.list}" var="tag" varStatus="status">
												<tr>
													...
													<td class="align-left">
													<a data-self-href="${ctx}/entity/tag/error/list.vm?THS_JDP_RES_ID=${THS_JDP_RES_ID}&searchType=error&readonly=true&ENTITY_ID=${entityId }&tagCode=${tag.TAG_CODE}" data-toggle="tooltip" title="标签值域不符企业数">${tag.DATA_COUNT}</a>
													</td>
...
<script type="text/javascript">
	...
	function doCheck(){
    	$.ajax({
     	   type: "GET",
     	   url: "${ctx}/tagcount/runErrorCount.vm?entityId="+$('#entityId').val(),
     	   dataType: "text",
